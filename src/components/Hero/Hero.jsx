...
import NotionSidebar from "../NotionSidebar/NotionSidebar";
    ...
    <div className="flex flex-col lg:flex-row gap-4 md:gap-6 lg:gap-8 pb-4 lg:mb-36 w-full mx-auto px-3 md:px-4">
      ...
      <div className="w-full lg:flex-[3] max-w-full md:max-w-2xl lg:max-w-[976px]">
        ...
        <motion.div
          ...
          className="mb-8 border border-stone-800 rounded-lg p-4"
        >
        ...
        <motion.div
          ...
          className="mt-8 border border-stone-800 rounded-lg p-4"
        >
          <div className="mb-6">
            <h3 className="text-3xl font-semibold flex items-center gap-3 text-white">
      ...
      {/* Notion Sidebar - 25% (Fixed) */}
      <div className="hidden lg:block flex-[1] w-80">
        <NotionSidebar />
      </div>
    </div>
  );
